  ...
  return (
    <section className="py-10 md:py-20" id="contact">
      <TextRevealByWord text="Vous pensez que mon profil correspond à une offre de stage ? Contactez-moi !">
        ...
        >
          <a
            href="https://github.com/volkoffff"
            className="size-16 flex items-center justify-center bg-black hover:bg-black/80 hover:cursor-pointer text-white text-2xl"
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
          ...
          <a
            href="mailto:robin.lanfranchi1338@gmail.com"
            className="size-16 flex items-center justify-center bg-black hover:bg-black/80 hover:cursor-pointer text-white text-2xl"
          >
            <svg
              stroke="currentColor"
