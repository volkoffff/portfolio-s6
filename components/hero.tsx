    ...
    <section className="h-screen p-12 pt-20 flex flex-col justify-between">
      <div>
        <p className="flex items-start justify-between pointer-events-none user-select-none">
          <span className="ml13 pointer-events-none user-select-none tracking-[-0.06em] leading-none text-[14vw] font-semibold translate-y-[-14%] translate-x-[-1.2%]">
            LANFRANCHI
          </span>
          <span className="pointer-events-none user-select-none tracking-normal leading-none font-semibold text-[5vw] translate-y-[-14%]">
            TM
          </span>
        </p>
      </div>
